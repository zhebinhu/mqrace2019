...
public class ValueReader {
    ...
    public void put(Message message) {
        ...
        else if (messageNum >= 170000000 && messageNum < 230000000) {
            if (cache2 == null) {
                cache2 = new short[60000000];
            }
    ...
    public long get(int index, ValueContext valueContext) {
        ...
        else if (index >= 170000000 && index < 230000000) {
    ...
    public Avg avg(int offsetA, int offsetB, long aMin, long aMax, ValueContext valueContext) {
        ...
        while (offsetA < offsetB) {
            ...
            else if (offsetA >= 170000000 && offsetA < 230000000) {
