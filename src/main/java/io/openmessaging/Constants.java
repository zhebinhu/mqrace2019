...
public class Constants {
    ...
    public final static int TIME_PAGE_SIZE = 32 * 1024;

    public final static int TIME_CACHE_SIZE = 128 * 1024 * 1024;

    public final static int VALUE_PAGE_SIZE = 32 * 1024;

    public final static int VALUE_CACHE_SIZE = 128 * 1024 * 1024;
